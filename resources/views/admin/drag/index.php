                    ...
                    <div class="dd col-12" id="nestableDrag">
                        <ol class="dd-list">
                            <?php if (!empty($dragInfo)) foreach ($dragInfo as $k => $value) :
                                $dataPost = getByIdPage($value->id);
                            ?>
                                <?php if (!empty($dataPost)): ?>
                                    <li class="dd-item dd3-item" data-id="<?php echo $value->id; ?>" data-type="<?php echo $value->type; ?>" >
...
<script>
    var type = '<?php echo $heading_type ?>';
    var url_ajax_load_tournament = '<?php echo site_admin_url("drag/ajax_load/page"); ?>';
</script>
