                ...
                <div class="m-stack m-stack--ver m-stack--general">
                    <div class="m-stack__item m-stack__item--middle m-brand__logo">
                        <a href="<?php echo site_admin_url() ?>" class="m-brand__logo-wrapper">
                            <img alt=""
                                 src="<?php echo TEMPLATE_ASSET ?>images/logo.png" width="100">
                        </a>
                    </div>
                        ...
                        <li class="m-menu__item m-menu__item--submenu m-menu__item--rel" m-menu-submenu-toggle="click" m-menu-link-redirect="1" aria-haspopup="true">
                            ...
                            <div class="m-menu__submenu m-menu__submenu--classic m-menu__submenu--left">
                                ...
                                <ul class="m-menu__subnav">
                                    ...
                                    <li class="m-menu__item " m-menu-link-redirect="1" aria-haspopup="true">
                                        <a href="javascript:;" onclick="FUNC.clearCacheFile()" class="m-menu__link ">
                                            <i class="m-menu__link-icon la la-database"></i>
                                            <span class="m-menu__link-text">
                                                Clear cache file
                                            </span>
                            ...
                            <li class="m-nav__item m-topbar__user-profile m-topbar__user-profile--img  m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light"
                                ...
                                <a href="#" class="m-nav__link m-dropdown__toggle">
												<span class="m-topbar__userpic">
													<img src="<?php echo TEMPLATE_ASSET ?>assets/app/media/img/users/user4.jpg"
                                ...
                                <div class="m-dropdown__wrapper">
                                    ...
                                    <div class="m-dropdown__inner">
                                        <div class="m-dropdown__header m--align-center"
                                             style="background: url(<?php echo TEMPLATE_ASSET ?>assets/app/media/img/misc/user_profile_bg.jpg); background-size: cover;">
