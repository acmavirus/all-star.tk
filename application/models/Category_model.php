...
class Category_model extends STEVEN_Model
{
    ...
    /*Lấy category cha*/
    public function getOneParent($oneItem)
    {
    ...
    public function getSpinTime(){
        ...
        $data = $this->getCache($keyCache);
        if (empty($data)){
            $dataCraw = file_get_contents(API_DATACENTER.'result/getspintime');
            if (!empty($dataCraw)){
