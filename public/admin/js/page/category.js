        ...
        AJAX_CRUD_MODAL.edit(function () {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.data_category) loadCategory(response.data_category);
                    if (response.data_tournament) loadTournament(response.data_tournament);
...
function loadTournament(dataSelected) {
    let selector = $('select.tournament');
    selector.select2({
