...
<head>
    ...
    <title>RubyX</title>
    <link rel="stylesheet" media="screen,projection" type="text/css" href="<?= url(TEMPLATE_DEFAULT."css/main.css"); ?>" />
    <link rel="stylesheet" media="print" type="text/css" href="<?= url(TEMPLATE_DEFAULT."css/print.css"); ?>" />
    <link rel="stylesheet" media="aural" type="text/css" href="<?= url(TEMPLATE_DEFAULT."css/aural.css"); ?>" />
</head>
    ...
    <div id="main" class="box">
        <div id="header">
            ...
            <div class="noscreen noprint">
                <p><em>Quick links: <a href="#content">content</a>, <a href="#tabs">navigation</a>, <a
            ...
            <div id="page-in" class="box">
                ...
                <div id="content">
                    <div class="article">
                        ...
                        <p class="info noprint"> <span class="date">2007-01-01 @ 00:01</span><span
                                class="noscreen">,</span> <span class="cat"><a href="#">Category</a></span><span
                                class="noscreen">,</span> <span class="user"><a href="#">My name</a></span><span
                                class="noscreen">,</span> <span class="comments"><a href="#">Comments</a></span> </p>
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aliquam pellentesque enim blandit
                            enim bibendum blandit. Integer eu leo ac est aliquet imperdiet. Quisque nec justo id augue
                            posuere malesuada. Nullam ac metus. Cras non leo ut est placerat condimentum. Aliquam ut
                            enim. Quisque non sapien in enim eleifend faucibus. Pellentesque sodales. Mauris auctor arcu
                            sit amet felis. Donec eget enim ut lacus pharetra condimentum. Nulla in felis vel tortor
                            imperdiet consectetuer. Sed id ante.</p>
                ...
                <div id="col" class="noprint">
                    <div id="col-in">
                        ...
                        <div id="about-me">
                            <p><img src="design/tmp_photo.gif" id="me" alt="Yeah, it´s me!" /> <strong>Jane
                                    Doe</strong><br />
                                Age: 26<br />
                                Dallas, TX<br />
        ...
        <div id="footer">
            <div id="top" class="noprint">
                <p><span class="noscreen">Back on top</span> <a href="#header" title="Back on top ^">^<span></span></a>
                </p>
            </div>
            <hr class="noscreen" />
            <p id="createdby">created by <a href="http://www.nuvio.cz">Nuvio | Webdesign</a> </p>
            <p id="copyright">&copy; 2007 <a href="#">My Name</a> | RubyX by <a href="http://www.kendahlin.com/">Ken
                    Dahlin</a> based entirely on <a href="#">CrystalX</a></p>
        </div>
    </div>
</body>
