...
<div class="container">
    <div style="margin-top: 8px;width: 100%" class="text-center">
        <h1 style=" color: #D0021B; font-size: 18px; font-weight: 600">Soi cầu nhiều nháy xsmb <?php echo $oneItem->code ?> hôm nay </h1>
    </div>
</div>
            ...
            <div class="viewStatistic">
                <article>
                    <div class="static-search mt-0">
                        <div class="aside-title-red text-center">
                            <h2 class="title"> Soi cầu nhiều nháy XSMB </h2>
                        </div>
                ...
                <article class="mt-2 bg-white">
                    <div class="logan-result">
                        <div class="title-blue"> Soi cầu nhiều nháy XSMB hôm nay </div>
