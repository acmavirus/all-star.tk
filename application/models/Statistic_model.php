...
class Statistic_model extends STEVEN_Model
{
    ...
    public function xien2($params){
        ...
        $rs = callCURL(API_DATACENTER."api/v4/statistic_loto/loxien2thinh", $params);
        $rs = $rs['data']['data'];
    ...
    public function xien3($params){
        ...
        $rs = callCURL(API_DATACENTER."api/v4/statistic_loto/loxien3thinh", $params);
        $rs = $rs['data']['data'];
...
//        params: code, limit, dateEnd
        ...
        $rs = callCURL(API_DATACENTER."api/v4/statistic_loto/lokep", $params);
        $rs = $rs['data']['data_kep'];
...
//        $params: code, date_end, limit, is_special
        ...
        $rs = callCURL(API_DATACENTER."api/v4/statistic_loto/tansuat_loto", $params);
        $rs = $rs['data'];
...
//        $params: code, month, year
        ...
        $rs = callCURL(API_DATACENTER."api/v4/statistic_dacbiet/getByYear", $params);
        $rs = $rs['data'];
    ...
    public function dbtuan($params){
        ...
        $rs = callCURL(API_DATACENTER."api/v4/statistic_dacbiet/getByMonth", $params);
        $rs = $rs['data'];
    ...
    public function dbtuanprovince($params){
        ...
        $rs = callCURL(API_DATACENTER."api/v4/statistic_dacbiet/getByMonthxsp", $params);
        $rs = $rs['data'];
    ...
    public function dacbiet($params){
        ...
        if (empty($return)){
            $rs = callCURL(API_DATACENTER."api/v4/statistic_dacbiet/last2number", $params)['data'];
    ...
    public function logan($params){
        ...
        $rs = callCURL(API_DATACENTER."api/v4/statistic_loto/loganxsp",$params);
...
//        $params: code, date_begin, date_end
        ...
        $rs = callCURL(API_DATACENTER.'api/v4/statistic_loto/dauduoi_loto', $params);
        $rs = $rs['data'];
    ...
    public function ganDauDuoiTong($params){
        ...
        $rs = callCURL(API_DATACENTER.'api/v4/statistic_loto/gan_dau_duoi_tong', $params);
        $rs = json_decode($rs, true);
...
//        $params: code, sum, date_begin, date_end
        ...
        if (empty($data)){
            $data = callCURL(API_DATACENTER.'api/v4/statistic_loto/lotong', $params);
    ...
    public function getBachThu($code,$type = 'bachthu', $return = 'js'){
        ...
        //$rs = $this->getCache($keyCache);
        if (empty($rs)) {
            $rs = callCURL(API_DATACENTER."api/v4/soicau/js$type/$code", []);
    ...
    public function getLatLienTuc($return = 'js'){
        ...
        if(empty($data_js)){
            $data_js = callCURL(API_DATACENTER."api/v4/soicau/latlientuc");
    ...
    public function getLoto() {
        ...
        if (empty($data)) {
            $data = callCURL(API_DATACENTER.'api/v4/page/lo_to');
            $data = $data['data'];
