...
<div class="user-profile">
	<div class="profile-header-background">
		<img src="<?php echo TEMPLATE_ASSET.'images/city.jpg' ?>" alt="Profile Header Background">
	</div>
	<div class="row">
		<div class="col-md-1">
		</div>
		<div class="col-md-4">
			<div class="profile-info-left">
				<div class="text-center">
					<img src="<?php echo TEMPLATE_ASSET.'images'?>/avatar1.png" alt="Avatar" class="avatar img-circle">
