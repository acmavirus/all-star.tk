            ...
            <li class="m-menu__item  m-menu__item--submenu seo" aria-haspopup="true" m-menu-submenu-toggle="hover">
                ...
                <div class="m-menu__submenu ">
                    ...
                    <ul class="m-menu__subnav">
                        ...
                        <li class="m-menu__item " aria-haspopup="true">
                            <a href="<?php echo site_admin_url('category/soicau') ?>" class="m-menu__link ">
                                <i class="m-menu__link-bullet m-menu__link-bullet--dot">
                                    <span></span>
                                </i>
                                <span class="m-menu__link-text">
                                    Danh sách page Soi cầu Thống kê
                                </span>
                            </a>
                        </li>
                    </ul>
...
<!--            onpage-->
            <li class="m-menu__item">
                <a href="<?php echo site_admin_url('onpage') ?>" class="m-menu__link">
                    ...
                    <span class="m-menu__link-text">Quản lý onpage</span>
                </a>
            </li>
...
<!--            banner-->
            <li class="m-menu__item">
                <a href="<?php echo site_admin_url('banner') ?>" class="m-menu__link">
                    <i class="m-menu__link-icon flaticon-settings"></i>
                    <span class="m-menu__link-text">Quản lý banner</span>
                </a>
            </li>
