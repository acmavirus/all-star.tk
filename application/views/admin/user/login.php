...
<body class="m--skin- m-header--fixed m-header--fixed-mobile m-aside-left--enabled m-aside-left--skin-dark m-aside-left--offcanvas m-footer--push m-aside--offcanvas-default">
    ...
    <div class="m-grid m-grid--hor m-grid--root m-page">
        <div class="m-grid__item m-grid__item--fluid m-grid m-grid--hor m-login m-login--signin m-login--2 m-login-2--skin-3" id="m_login" style="background-color: darkgray">
            <div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
                <div class="m-login__container">
                    <div class="m-login__logo">
                        <a href="#">
                            <img alt="Logo" width="200" src="<?php echo base_url("public/logo.png?v=" . ASSET_VERSION) ?>">
                        </a>
                    </div>
                    <div class="m-login__signin">
                        <?php echo form_open(site_admin_url('user/ajax_login'), ['class' => 'm-login__form m-form']); ?>
                        <div class="form-group m-form__group">
                            <input class="form-control m-input" type="text" placeholder="Username / Email" name="identity" autocomplete="off">
                        </div>
                        <div class="form-group m-form__group">
                        ...
                        <div class="m-login__form-action">
                            ...
                            <button type="submit" id="m_login_signin_submit" class="btn btn-danger m-btn m-btn--pill m-btn--custom m-btn--bold m-login__btn">
                                Login
                            </button>
                        </div>
                        <?php echo form_close() ?>
